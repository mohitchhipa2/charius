...
const CausesSectionS3 = () => {
    return ( <
        ...
        <
        SectionTitle subtitle = "Featured Cause"
        title = "Find the popular cause" / >
        <
        /div> <
        /div> <
        ...
        <
        Link to = "/causes-single"
        className = "causes-btn"
        onClick = {
            ClickHandler
        } > See All Causes < i className = "flaticon-right-arrow-2" > < /i></Link >
        <
        /div> <
        /div> <
        /div> <
