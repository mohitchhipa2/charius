...
const DonateSection = () => {
    ...
    return ( <
        ...
        <
        div className = "wpo-payment-option"
        id = "open4" >
        <
        ...
        <
        button type = "submit"
        className = "theme-btn submit-btn" > Donate Now < /button> <
        /div> <
        /form> <
        /div> <
        /div> <
