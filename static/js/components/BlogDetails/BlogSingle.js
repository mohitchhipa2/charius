...
const BlogSingle = (props) => {
    ...
    return ( <
        ...
        <
        div className = {
            `col col-lg-8 col-12 ${props.blRight}`
        } >
        <
        ...
        p > There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don 't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn'
        t anything embarrassing hidden in the middle of text.All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.It uses a dictionary of over 200 Latin words, combined with a handful. < /p> <
        blockquote >
        ...
        <
        Link to = "/blog-single/1"
        className = "author-name" > Author: Bernard Rodgers < /Link> <
        ...
        <
        h4 > John Abraham < span className = "comments-date" > January 12, 2024 At 9.00 am < /span></h
        4 >
        <
        /div> <
        div className = "comment-area" >
        <
        p > I will give you a complete account of the system, and expound the actual teachings of the great explorer of
        the truth, < /p> <
        div className = "comments-reply" >
        <
        Link className = "comment-reply-link"
        to = "/blog-single/1" > < span > Reply < /span></Link >
        <
        /div> <
        /div> <
        /div> <
        ...
        div className = "comments-meta" >
        <
        h4 > Lily Watson < span className = "comments-date" > January 12, 2024 At 9.00 am < /span></h
        4 >
        <
        /div> <
        div className = "comment-area" >
